    ...
    public partial class migracja1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, 1, new DateTime(2022, 6, 23, 11, 25, 16, 239, DateTimeKind.Local).AddTicks(6315) });

            migrationBuilder.InsertData(
                table: "Membership",
                columns: new[] { "MemberID", "TeamID", "MembershipDate" },
                values: new object[] { 1, 2, new DateTime(2022, 6, 23, 11, 25, 16, 237, DateTimeKind.Local).AddTicks(7192) });
